...
function Blurb() {
    ...
    return (
        ...
        <div className="relative flex flex-col justify-center h-auto w-screen mx-auto px-2 overflow-hidden">
            <p className='mt-12 uppercase text-4xl md:text-5xl text-gray-800 max-w-6xl mx-auto font-staat text-center leading-relaxed tracking-wide md:leading-relaxed md:tracking-wide px-2'><span className='text-6xl sm:text-8xl font-slab text-slate-50 font-bold textShadow6'>Sign Up Today</span><br/>Recieve 50 Points</p>
            <div className='flex md:flex-row flex-col h-auto w-full max-w-5xl mt-12 mx-auto'>
            ...
            <div className='flex justify-center items-center h-auto bg-amber-300 rounded-lg shadow-lg w-full max-w-5xl mt-2 mb-16 mx-auto'>
            ...
            <img src={rewardsBackground} className='absolute top-0 -left-40 md:left-0 scale-[400%] md:scale-100 opacity-[4%] -z-10' />
